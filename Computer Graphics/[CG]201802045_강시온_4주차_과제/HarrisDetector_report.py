...
def HarrisDetector(src, gaus_filter_size = 3, gaus_sigma = 1, alpha = 0.04, threshold_rate = 0.01):
    ...
    cv2.imshow('201802045 - dst_x_Norm', dst_x_Norm)
    cv2.imshow('201802045 - dst_y_Norm', dst_y_Norm)
    cv2.waitKey()
    cv2.destroyWindow('201802045 - dst_x_Norm')
    cv2.destroyWindow('201802045 - dst_y_Norm')
    ...
    cv2.imshow('201802045 - IxIx', IxIx)
    cv2.imshow('201802045 - IyIy', IyIy)
    #cv2.imshow('IxIy', IxIy)
    cv2.imshow('201802045 - dst_IxIy_Norm', dst_IxIy_Norm)
    cv2.waitKey()
    cv2.destroyWindow('201802045 - IxIx')
    cv2.destroyWindow('201802045 - IyIy')
    #cv2.destroyWindow('IxIy')
    cv2.destroyWindow('201802045 - dst_IxIy_Norm')
    ...
    cv2.imshow('201802045 - G_IxIx', G_IxIx)
    cv2.imshow('201802045 - G_IyIy', G_IyIy)
    #cv2.imshow('G_IxIy', G_IxIy)
    cv2.imshow('201802045 - G_dst_IxIy_Norm', G_dst_IxIy_Norm)
    cv2.waitKey()
    cv2.destroyWindow('201802045 - G_IxIx')
    cv2.destroyWindow('201802045 - G_IyIy')
    #cv2.destroyWindow('G_IxIy')
    cv2.destroyWindow('201802045 - G_dst_IxIy_Norm')
    ...
    """
    har = G_IxIx * G_IyIy - G_IxIy ** 2 - alpha * (G_IxIx + G_IxIy) ** 2

    #0 ~ 1 사이의 값으로 변경 후 0 ~ 255로 변경 -> 결과가 잘 나왔는지 확인하기위해서
    G_dst_har_Norm = ((har - np.min(har) )/np.max(har - np.min(har)) * 255 + 0.5).astype(np.uint8)
    cv2.imshow('201802045 - har before threshold', G_dst_har_Norm)
    ...
    cv2.imshow('201802045 - har after threshold', G_dst_har_thresh_Norm)
...
def main():
    ...
    cv2.imshow('201802045 - original', src)
    ...
    cv2.imshow('201802045 - interest points', interest_points)
    cv2.imshow('201802045 - harris_img', harris_img)
    cv2.waitKey()
